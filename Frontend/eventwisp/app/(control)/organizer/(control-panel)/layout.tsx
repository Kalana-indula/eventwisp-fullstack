...
import SideNavBar from "@/app/(control)/organizer/organizer-components/SideNavBar";
import OrganizerHeader from "@/app/(control)/organizer/organizer-components/OrganizerHeader";
        ...
        <div className="flex relative">
            ...
            <div className="flex-1 h-screen flex flex-col sm:ml-0">
                ...
                <div className="top-0 flex justify-center z-30 bg-white w-full">
                    <OrganizerHeader isNavBarOpen={isNavBarOpen} toggleNavBar={toggleNavBarOpen}/>
                </div>

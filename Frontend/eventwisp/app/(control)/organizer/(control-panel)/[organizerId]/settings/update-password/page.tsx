                            ...
                            <div className="bg-white shadow-2xl p-8 rounded-lg">
                                <form className="space-y-6" onSubmit={handleUpdatePassword}>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Button
                                            type="submit"
                                            className="w-full bg-blue-600 hover:bg-blue-700 flex justify-center py-3 px-4 rounded-lg shadow-sm text-sm font-medium text-white active:bg-blue-600 active:text-white hover:cursor-pointer">
                                            Save
                                        </Button>
